...
class CourseAnalyzer:
    ...
    COURSE_RECORDS: dict = {
        # ※ 出典: netkeiba コースレコード一覧（2025年11月30日更新）
        # ※ 芝のみ。ダートは別途未実装。
        # ※ キー: (コース名, 距離)  コース名はdetect_track_variant後の詳細名

        # 東京
        ('東京',   1400):  78.3,   # 1:18.3 トウシンマカオ  2025/5/3
        ('東京',   1600):  90.5,   # 1:30.5 ノームコア     2019/5/12
        ('東京',   1800): 103.9,   # 1:43.9 セイウンハーデス 2025/5/10
        ('東京',   2000): 115.2,   # 1:55.2 イクイノックス  2023/10/29
        ('東京',   2300): 138.4,   # 2:18.4 アルピーアシャ  2021/4/24
        ('東京',   2400): 140.3,   # 2:20.3 カランダガン    2025/11/30
        ('東京',   2500): 148.2,   # 2:28.2 ルックトゥワイス 2019/5/26
        ('東京',   3400): 209.1,   # 3:29.1 ミクソロジー    2023/2/18

        # 阪神内回り
        ('阪神内', 1200):  66.7,   # 1:06.7 タワーオブロンドン 2019/9/8
        ('阪神内', 1400):  79.2,   # 1:19.2 レシステンシア  2021/2/28
        ('阪神内', 2200): 129.7,   # 2:09.7 タイトルホルダー 2022/6/26
        # 阪神外回り
        ('阪神外', 1600):  91.1,   # 1:31.1 ソダシ         2021/4/11
        ('阪神外', 1800): 103.0,   # 1:43.0 マスクトディーヴァ 2023/9/17
        ('阪神外', 2000): 116.2,   # 1:56.2 ペラジオオペラ  2025/4/6
        ('阪神外', 2400): 143.5,   # 2:23.5 サトノグランツ  2023/9/24
        ('阪神外', 2600): 155.1,   # 2:35.1 ミスマンマミーア 2021/4/11
        ('阪神外', 3000): 182.4,   # 3:02.4 アスクビクターモア 2022/10/23
        ('阪神外', 3200): 194.7,   # 3:14.7 ワールドプレミア 2021/5/2

        # 中山
        ('中山',   1200):  66.7,   # 1:06.7 ロードカナロア  2012/9/30
        ('中山',   1600):  90.3,   # 1:30.3 トロワゼトワル  2019/9/8
        ('中山',   1800): 104.8,   # 1:44.8 シックスペンス  2025/3/2
        ('中山',   2000): 116.6,   # 1:56.6 クリスマスパレード 2024/9/7
        ('中山',   2200): 130.1,   # 2:10.1 コスモバルク    2004/9/19
        ('中山',   2500): 149.5,   # 2:29.5 ゼンノロブロイ  2004/12/26
        ('中山',   3600): 221.6,   # 3:41.6 エアダブリン    1994/12/10

        # 京都内回り
        ('京都内', 1200):  66.7,   # 1:06.7 ヘニーハウンド  2014/10/12
        ('京都内', 1400):  79.9,   # 1:19.9 エイシンペペラッツ 2014/4/26
        ('京都内', 1600):  92.2,   # 1:32.2 チュウワノキセキ 2020/5/9
        ('京都内', 1800): 103.9,   # 1:43.9 グランデッツァ  2014/5/17
        ('京都内', 2000): 116.8,   # 1:56.8 アドマイヤコスモス 2011/10/8
        # 京都外回り
        ('京都外', 1400):  79.0,   # 1:19.0 ウリウリ       2015/5/31
        ('京都外', 1600):  91.3,   # 1:31.3 サングレーザー  2018/4/22
        ('京都外', 2200): 129.7,   # 2:09.7 ネプチュナイト  2019/4/21
        ('京都外', 2400): 142.6,   # 2:22.6 サンエムエックス 2000/10/15
        ('京都外', 3000): 181.0,   # 3:01.0 トーホウジャッカル 2014/10/26
        ('京都外', 3200): 192.5,   # 3:12.5 キタサンブラック 2017/4/30

        # 中京
        ('中京',   1200):  66.2,   # 1:06.2 メイケイエール  2022/9/11
        ('中京',   1400):  78.7,   # 1:18.7 アクートゥス    2025/8/2
        ('中京',   1600):  92.2,   # 1:32.2 ラヴォルシエル  2022/9/11
        ('中京',   2000): 116.5,   # 1:56.5 リフレーミング  2024/8/11
        ('中京',   2200): 129.0,   # 2:09.0 プリマヴィスタ  2022/5/8
        ('中京',   3000): 183.4,   # 3:03.4 ミクソロジー    2023/1/5

        # 札幌
        ('札幌',   1000):  56.5,   # 56秒5  オギティファニー 1996/6/23
        ('札幌',   1200):  67.4,   # 1:07.4 シュバルツカイザー 2023/7/23
        ('札幌',   1500):  87.3,   # 1:27.3 ヴァトレニ      2021/6/27
        ('札幌',   1800): 105.7,   # 1:45.7 キャトルフィーユ 2014/8/3
        ('札幌',   2000): 118.6,   # 1:58.6 タスカータソルテ 2008/8/24
        ('札幌',   2600): 157.6,   # 2:37.6 ポンデザール    2020/8/8

        # 函館
        ('函館',   1000):  57.0,   # 57秒0  ソロシンガー    1997/6/22
        ('函館',   1200):  66.6,   # 1:06.6 カビリナ        2025/6/14
        ('函館',   1800): 104.8,   # 1:44.8 ケイアイセナ    2025/7/13
        ('函館',   2000): 117.6,   # 1:57.6 ヴェローチェエラ 2025/6/29
        ('函館',   2600): 157.3,   # 2:37.3 メイショウガーデン 2017/6/17

        # 新潟（内外別）
        ('新潟',   1000):  53.7,   # 53秒7  カルストンライトオ 2002/8/18  ※直線専用
        ('新潟内', 1200):  67.5,   # 1:07.5 ガンアンドローズ 2002/8/3
        ('新潟内', 1400):  79.0,   # 1:19.0 マグナーテン    2002/7/14
        ('新潟外', 1600):  91.0,   # 1:31.0 カナテープ      2025/7/27
        ('新潟外', 1800): 104.0,   # 1:44.0 クルゼイロドスル 2024/7/27
        ('新潟外', 2000): 116.4,   # 1:56.4(基準) ツジノワンダー 2001/7/14
        ('新潟内', 2000): 118.9,   # 1:58.9 デッドリー      2023/8/6
        ('新潟外', 2200): 130.8,   # 2:10.8 ダブルフラット  2018/8/5
        ('新潟外', 2400): 144.4,   # 2:24.4 レイオブウォーター 2021/7/24

        # 福島
        ('福島',   1200):  67.0,   # 1:07.0 シルキーラグーン 2005/6/19
        ('福島',   1800): 105.3,   # 1:45.3 アンブラスモア  1998/6/21
        ('福島',   2000): 117.3,   # 1:57.3 ダイワファルコン 2013/11/17
        ('福島',   2600): 157.3,   # 2:37.3 サクセスパシュート 2012/11/3

        # 小倉
        ('小倉',   1200):  65.8,   # 1:05.8 テイエムスパーダ 2022/7/3
        ('小倉',   1800): 103.8,   # 1:43.8 エスコーラ      2021/7/3
        ('小倉',   2000): 116.8,   # 1:56.8 ガイアフォース  2022/7/3
        ('小倉',   2600): 156.4,   # 2:36.4 シルキーヴォイス 2022/7/2
    }
