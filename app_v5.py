...
st.set_page_config(page_title="競馬予想AI v8.0 (Scorer v6)", page_icon="🏇", layout="wide")

# scraperのインポート
_import_error = None
try:
    from scraper_v4 import NetkeibaRaceScraper
...
if _import_error:
    ...
    st.error("""
    **解決方法**:
    1. `scraper_v4.py` と `enhanced_scorer_v6.py` が同じディレクトリにあることを確認
